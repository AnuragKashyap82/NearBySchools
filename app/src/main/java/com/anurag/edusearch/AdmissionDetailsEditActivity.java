...
public class AdmissionDetailsEditActivity extends AppCompatActivity {

    ActivityAdmissionDetailsEditBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdmissionDetailsEditBinding.inflate(getLayoutInflater());
        ...
        binding.admissionIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showImagePickDialog();
            }
    ...
    private String admissionProcedure, googleFormLink;

    private void validateData() {

        admissionProcedure = binding.admissionProcedure.getText().toString().trim();
        googleFormLink = binding.googleFormLink.getText().toString().trim();

        if (TextUtils.isEmpty(admissionProcedure)) {
            Toast.makeText(this, "Provide Complete Procedure For admission...!", Toast.LENGTH_SHORT).show();
            return;
        } else if (image_uri == null) {
            Toast.makeText(this, "Choose Image...!", Toast.LENGTH_SHORT).show();
            return;
        } else if (TextUtils.isEmpty(googleFormLink)) {
            Toast.makeText(this, "Give the admission form Link....!", Toast.LENGTH_SHORT).show();
            return;
        } else {
    ...
    private void updateAdmissionDetails() {
        progressDialog.setMessage("Updating Admission Details");
        progressDialog.show();
        ...
        if (image_uri == null) {
            ...
            hashMap.put("admissionProcedure", "" + admissionProcedure);
            hashMap.put("admissionImage", "");
            hashMap.put("googleFormLink", "" + googleFormLink);
            hashMap.put("schoolId", "" + schoolId);
            hashMap.put("admissionId", "" + timestamp);


            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Admission");
            reference.child(schoolId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(AdmissionDetailsEditActivity.this, "Admission Details Updated Successfully...", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(AdmissionDetailsEditActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });

        } else {

            String filePathAndName = "admission_images/" + "" + schoolId;
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()) {
                                ...
                                HashMap<String, Object> hashMap = new HashMap<>();
                                hashMap.put("admissionProcedure", "" + admissionProcedure);
                                hashMap.put("admissionImage", "" + downloadImageUri);
                                hashMap.put("googleFormLink", "" + googleFormLink);
                                hashMap.put("schoolId", "" + schoolId);
                                hashMap.put("admissionId", "" + timestamp);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        binding.admissionIv.setImageURI(image_uri);
                    } else {
                        Toast.makeText(AdmissionDetailsEditActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
