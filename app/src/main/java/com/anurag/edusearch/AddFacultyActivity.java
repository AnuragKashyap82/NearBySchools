...
public class AddFacultyActivity extends AppCompatActivity {
    ...
    private String facultyName, facultyDescription;
    ...
    private void inputData() {
        ...
        if (TextUtils.isEmpty(facultyDescription)) {
...
//        }
    ...
    private void addFaculty() {
        ...
        if (image_uri == null) {
            ...
            hashMap.put("facultyId", "" + timestamp);
            ...
            ref.child(schoolId).child("Faculty").child(timestamp)
                    .setValue(hashMap)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(AddFacultyActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });

        } else {

            String filePathAndName = "faculty_images/" + "" + timestamp;
    ...
    private void clearData() {
        ...
        binding.facultyNameEt.setText("");
        binding.facultyDescriptionEt.setText("");
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(AddFacultyActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
