...
import com.anurag.edusearch.databinding.ActivityEditGalleryCategoryBinding;
...
public class EditGalleryCategoryActivity extends AppCompatActivity {

    ActivityEditGalleryCategoryBinding binding;
    ...
    private String schoolId, galleryId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEditGalleryCategoryBinding.inflate(getLayoutInflater());
        ...
        binding.updateGalleryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputData();
            }
    ...
    private void loadGalleryCategoryDetails() {
        ...
        ref.child(schoolId).child("Gallery").child(galleryId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        String galleryId = "" + snapshot.child("galleryId").getValue();
                        String galleryName = "" + snapshot.child("galleryName").getValue();
                        String galleryImage = "" + snapshot.child("galleryImage").getValue();
                        String schoolId = "" + snapshot.child("schoolId").getValue();
                        String uid = "" + snapshot.child("uid").getValue();

                        binding.categoryNameEt.setText(galleryName);

                        try {
                            Picasso.get().load(galleryImage).placeholder(R.drawable.ic_person_gray).into(binding.categoryIv);
            ...
            ref.child(schoolId).child("Gallery").child(galleryId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(EditGalleryCategoryActivity.this, "Gallery Updated Successfully...", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(EditGalleryCategoryActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });

        } else {

            String filePathAndName = "gallery_images/" + "" + galleryId;
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(EditGalleryCategoryActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
