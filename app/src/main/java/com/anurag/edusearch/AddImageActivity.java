...
public class AddImageActivity extends AppCompatActivity {
    ...
    private void inputData() {
        ...
        if (image_uri == null) {
            Toast.makeText(this, "Add Image to be Uploaded....!", Toast.LENGTH_SHORT).show();
            return;
        }
...
//        }
    ...
    private void uploadImage() {
        ...
        String filePathAndName = "images_images/" + "" + timestamp;
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uriTask.isSuccessful()) {
                            ...
                            ref.child(schoolId).child("Gallery").child(galleryId).child("Images").child(timestamp)
                                    .setValue(hashMap)
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(AddImageActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
