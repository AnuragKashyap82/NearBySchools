...
public class ModelSchool {
    ...
    public ModelSchool(String schoolId, String avgRating, String schoolName, String board, String schoolImage, String email, String phoneNumber, String districtId, String district, String address, String uid) {
